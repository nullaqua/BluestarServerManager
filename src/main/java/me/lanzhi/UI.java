...
import me.lanzhi.ui.ColorPane;
import me.lanzhi.ui.ConfigPaneDrawer;
import me.lanzhi.ui.DownloadPaneDrawer;
import me.lanzhi.ui.LimDocument;
...
public class UI
{
    ...
    public static void init()
    {
        ...
        output.setDocument(new LimDocument(output,100));
        for (int i=0;i<100;i++)
        {
            output.append("\n");
        }
